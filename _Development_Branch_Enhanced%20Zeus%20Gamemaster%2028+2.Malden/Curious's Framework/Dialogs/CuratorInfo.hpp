class CuratorInfo
{
	...
	class controls
	{
		...
		class RscButton_1600: RscButton
		{
			...
			h = 0.044 * safezoneH;
			action = "closeDialog 0; hint ""You'll never see that menu again. Contact Curious to reclaim it!""; sleep 1; profileNamespace setVariable [""CUR_CuratorInfo"", 1]; saveProfileNamespace;";
		};
